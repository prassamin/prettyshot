...
function MobileCard({
  ...
  return (
    <div
      className="relative w-full overflow-hidden rounded-2xl ring-1 ring-white/8"
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          transform: showAfter ? "scale(1)" : "scale(1.05)",
        }}
      >
        <Image
          src={pair.after}
...
export function Gallery() {
  ...
  const beforeImages = pairs.map((p) => ({
    src: p.before,
    w: p.bw,
    h: p.bh,
    label: p.label,
  }));
  const afterImages = pairs.map((p) => ({
    src: p.after,
    w: p.aw,
    h: p.ah,
    label: p.label,
      ...
      >
        ...
        <div className="mx-auto w-full max-w-6xl">
          ...
          <div className="mb-12 text-center lg:mb-16">
            <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-white/6 px-3.5 py-1.5 text-xs font-semibold text-white/50 ring-1 ring-white/8">
