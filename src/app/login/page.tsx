    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#faf8f6] p-4 sm:p-8">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
        <div 
          ...
          style={{
            background: "linear-gradient(135deg, #fb923c, #f472b6, #a78bfa, #60a5fa, #fb923c)",
            ...
            <div className="relative flex w-full flex-col justify-between border-r border-white/30 bg-linear-to-br from-white/40 to-transparent p-10 md:w-5/12 lg:p-14">
              <div>
                <Link href="/" className="inline-flex items-center gap-2 transition-transform hover:scale-105">
                  <div className="flex size-10 items-center justify-center rounded-xl bg-zinc-900 shadow-lg shadow-zinc-900/20">
                    <div className="size-4 rounded-full bg-linear-to-br from-orange-400 to-violet-500" />
                  </div>
                  <span className="text-2xl font-bold tracking-tight text-zinc-900">PrettyShot</span>
                </Link>
                
                <h2 className="mt-12 text-3xl font-extrabold leading-tight tracking-tight text-zinc-900 sm:text-4xl">
                  Turn boring <br/> screenshots <br/> into <span className="bg-linear-to-r from-orange-500 via-rose-500 to-violet-500 bg-clip-text text-transparent">masterpieces.</span>
                </h2>
                
                <p className="mt-6 text-sm font-medium text-zinc-500">
                  Join thousands of creators making their apps look stunning in seconds. No complex software required.
                </p>
              </div>
            ...
            <div className="flex w-full flex-col justify-center bg-white/30 p-10 md:w-7/12 lg:p-16">
              <div className="mx-auto w-full max-w-sm">
                <div className="mb-10 text-center">
                  <h3 className="mb-2 text-2xl font-bold text-zinc-900">Welcome Back</h3>
                  <p className="text-sm font-medium text-zinc-500">
                    Sign in to access your saved styles, view your history, and manage your account.
                  </p>
                </div>
                ...
                <div className="mt-10 flex items-center gap-4">
                  ...
                  <span className="text-xs font-semibold uppercase tracking-widest text-zinc-400">Secure</span>
                  <div className="h-px flex-1 bg-zinc-200" />
                </div>

                <p className="mt-8 text-center text-xs font-medium leading-relaxed text-zinc-400">
                  We care about your privacy. By continuing, you agree to our <br/>
                  <Link href="#" className="text-zinc-600 underline decoration-zinc-300 underline-offset-4 hover:text-zinc-900">Terms of Service</Link> and <Link href="#" className="text-zinc-600 underline decoration-zinc-300 underline-offset-4 hover:text-zinc-900">Privacy Policy</Link>.
                </p>
              </div>
            </div>
          </div>
