      ...
      >
        {!isPro ? (
          <div className="relative flex flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-200/80 bg-zinc-50/50 py-24 px-4 text-center overflow-hidden">
            ...
            <h3 className="relative z-10 text-lg font-semibold text-zinc-900">Cloud Sync is a Pro feature</h3>
          ...
          <div className="flex items-center justify-center py-32">
            <div className="size-8 animate-spin rounded-full border-3 border-zinc-200 border-t-orange-500" />
          </div>
        ) : designs.length > 0 ? (
          ...
          <div className="relative flex flex-col items-center justify-center rounded-3xl border border-dashed border-zinc-200/80 bg-zinc-50/50 py-24 px-4 text-center overflow-hidden">
            ...
            <h3 className="relative z-10 text-lg font-semibold text-zinc-900">It&apos;s pretty empty here</h3>
            <p className="relative z-10 mt-2 text-sm text-zinc-500 font-medium max-w-sm">
              You haven&apos;t created any designs yet. Click the button above to get started!
            </p>
          </div>
        )}
      </motion.div>
